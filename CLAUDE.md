...
- `/download/*` redirects supported desktop requests to mutable GitHub `auto-latest` artifacts by default. Those artifacts currently have no published artifact signature, code-signing proof, reproducibility result, or provenance attestation.
