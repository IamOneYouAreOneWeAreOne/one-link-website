...
const OlPqKemKeypairFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_olpqkemkeypair_free(ptr >>> 0, 1));

export class OlPqKemKeypair {

    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        OlPqKemKeypairFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_olpqkemkeypair_free(ptr, 0);
    }
    /**
     ...
     */
    get publicKeyBytes() {
        const ret = wasm.olpqkemkeypair_publicKeyBytes(this.__wbg_ptr);
    ...
    decapsulate(ct_bytes) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.olpqkemkeypair_decapsulate(this.__wbg_ptr, ptr0, len0);
        if (ret[3]) {
     ...
     */
    constructor() {
        const ret = wasm.olpqkemkeypair_new();
        this.__wbg_ptr = ret >>> 0;
        OlPqKemKeypairFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}

const PqKemSizesFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_pqkemsizes_free(ptr >>> 0, 1));
/**
 * Wire lengths exposed to JS so the bridge can validate buffer sizes
 * before sending bytes over the network.
 */
export class PqKemSizes {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(PqKemSizes.prototype);
        obj.__wbg_ptr = ptr;
        PqKemSizesFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        PqKemSizesFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_pqkemsizes_free(ptr, 0);
    }
    /**
     * @returns {number}
     */
    get public_key_bytes() {
        const ret = wasm.__wbg_get_pqkemsizes_public_key_bytes(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} arg0
     */
    set public_key_bytes(arg0) {
        wasm.__wbg_set_pqkemsizes_public_key_bytes(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get secret_key_bytes() {
        const ret = wasm.__wbg_get_pqkemsizes_secret_key_bytes(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} arg0
     */
    set secret_key_bytes(arg0) {
        wasm.__wbg_set_pqkemsizes_secret_key_bytes(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get ciphertext_bytes() {
        const ret = wasm.__wbg_get_pqkemsizes_ciphertext_bytes(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} arg0
     */
    set ciphertext_bytes(arg0) {
        wasm.__wbg_set_pqkemsizes_ciphertext_bytes(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get shared_secret_bytes() {
        const ret = wasm.__wbg_get_pqkemsizes_shared_secret_bytes(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} arg0
     */
    set shared_secret_bytes(arg0) {
        wasm.__wbg_set_pqkemsizes_shared_secret_bytes(this.__wbg_ptr, arg0);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('ol_pqkem_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
