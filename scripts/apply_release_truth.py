...
COPY = {
    "en": {
        ...
        "download_lede": "The desktop artifacts below are mutable continuous alpha builds from GitHub's auto-latest channel. They are not an immutable versioned release. Artifact signatures, publisher code signing, reproducible-build evidence, and provenance attestations are not published.",
        ...
        "repro_p": "No byte-for-byte reproducibility result or artifact-bound build attestation is published for the rolling builds.",
        ...
        "release_lede": "auto-latest is a mutable prerelease channel. It provides useful test artifacts, but it can change in place and currently has no published artifact signature, code-signing proof, reproducibility result, or provenance attestation.",
    ...
    "es": {
        ...
        "download_lede": "Los artefactos de escritorio son compilaciones alfa continuas y mutables del canal auto-latest de GitHub. No son una versión inmutable. No se publican firmas de artefacto, firma del editor, pruebas de compilación reproducible ni atestaciones de procedencia.",
        ...
        "repro_p": "Las compilaciones continuas no publican un resultado reproducible byte a byte ni una atestación vinculada al artefacto.",
        ...
        "release_lede": "auto-latest es un canal preliminar mutable. Sus artefactos sirven para pruebas, pero pueden cambiar y no publican firma, prueba de firma del editor, resultado reproducible ni atestación de procedencia.",
    ...
    "fr": {
        ...
        "download_lede": "Les artefacts de bureau sont des builds alpha continus et modifiables du canal auto-latest de GitHub. Ce ne sont pas des versions immuables. Aucune signature d'artefact, signature d'éditeur, preuve de reproductibilité ou attestation de provenance n'est publiée.",
        ...
        "repro_p": "Aucun résultat reproductible octet par octet ni attestation liée à l'artefact n'est publié pour les builds continus.",
        ...
        "release_lede": "auto-latest est un canal préliminaire modifiable. Ses artefacts servent aux tests, mais peuvent changer et ne publient ni signature, ni preuve de signature d'éditeur, ni résultat reproductible, ni attestation de provenance.",
    ...
    "de": {
        ...
        "repro_p": "Für die kontinuierlichen Builds sind weder ein bytegleiches Reproduktionsergebnis noch eine artefaktgebundene Build-Attestierung veröffentlicht.",
        ...
        "release_lede": "auto-latest ist ein veränderlicher Vorabkanal. Seine Testartefakte können ausgetauscht werden und veröffentlichen derzeit keine Signatur, Herausgeberprüfung, Reproduktionsergebnis oder Herkunftsattestierung.",
    ...
    "pt": {
        ...
        "download_lede": "Os artefactos de desktop são builds alfa contínuos e mutáveis do canal auto-latest do GitHub. Não são uma versão imutável. Não estão publicadas assinaturas de artefacto, assinatura do editor, provas de build reproduzível ou atestações de proveniência.",
        ...
        "repro_p": "Os builds contínuos não publicam resultado reproduzível byte a byte nem atestação vinculada ao artefacto.",
        ...
        "release_lede": "auto-latest é um canal preliminar mutável. Os artefactos servem para testes, mas podem mudar e não publicam assinatura, prova de assinatura do editor, resultado reproduzível ou atestação de proveniência.",
    ...
    "it": {
        ...
        "download_lede": "Gli artefatti desktop sono build alfa continue e modificabili del canale auto-latest di GitHub. Non sono una release immutabile. Non sono pubblicate firme degli artefatti, firme dell'editore, prove di build riproducibile o attestazioni di provenienza.",
        ...
        "repro_p": "Le build continue non pubblicano un risultato riproducibile byte per byte né un'attestazione legata all'artefatto.",
        ...
        "release_lede": "auto-latest è un canale preliminare modificabile. Gli artefatti servono ai test, ma possono cambiare e non pubblicano firme, prove di firma dell'editore, risultati riproducibili o attestazioni di provenienza.",
